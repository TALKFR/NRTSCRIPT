...
var txWeb =
        {
            ...
            Init: function ()
            {
                ...
                else if (navigator.userAgent.indexOf("Netscape7/") >= 0) {
                    this.NS = true;
                }
                else if (navigator.userAgent.indexOf("Navigator/9") >= 0) {
                    this.NS = true;
                }
            ...
            Init: function ()
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        if (NixxisContactLink.clientLink.Contacts)
                            NixxisContactLink.contactInfo = NixxisContactLink.clientLink.Contacts.Get(NixxisContactLink.contactId);
                    }
                    catch (e) {
                    }
                }
            ...
            agent:
                    {
                        UserName: function ()
                        {
                            ...
                            if (!NixxisContactLink.clientLink)
                                return "Jane Doe";
                            return NixxisContactLink.clientLink.UserName;
                        },
                        UserAccount: function ()
                        {
                            ...
                            if (!NixxisContactLink.clientLink)
                                return "100";
                            return NixxisContactLink.clientLink.UserAccount;
                        },
                        Description: function ()
                        {
                            ...
                            if (!NixxisContactLink.clientLink)
                                return "100, Jane Doe";
                            return NixxisContactLink.clientLink.Description;
                        },
                        nixxisTestMsg: function () {
                            if (!NixxisContactLink.clientLink)
                                return;
                            return NixxisContactLink.clientLink.nixxisTestMsg("Hello");
                        }
                    },
            demo:
                    {
                        GetChatMsg: function (text) {
                            if (!NixxisContactLink.owner)
                                return;
                            return NixxisContactLink.owner.GetChatMsg();
                        }
                    },
            commands:
                    {
                        ...
                        mailForward: function (destination, delay, sendResponseNow)
                        {
                            ExternalFn.mailForward(destination, NixxisContactLink.contactId, delay, sendResponseNow);
                        }
                    },
            Qualification:
                    {
            ...
            Contact:
                    {
                        getStat: function ()
                        {
                            if (!NixxisContactLink.contactInfo)
                                return;
            ...
            Agenda:
                    {
                        ...
                        storeAppointmentByContact: function (dateTime, duration, description, area)
                        {
                            ...
                            if (rtn != "")
                            {
                                ...
                                if (list.length > 2)
                                    NixxisContactLink.Agenda.AppMember = list[2];
                                if (list.length > 3)
                                {
                                    //debugger;
                        ...
                        cancelAppointment: function ()
                        {
                            ...
                            if (!NixxisContactLink.Agenda.AppId)
                                return;
                            NixxisContactLink.Agenda.AppId = "";
                            NixxisContactLink.Agenda.AppDateMs = 0;
                            NixxisContactLink.Agenda.AppDate = null;
            ...
            Cmd:
                    {
                        ...
                        voicetransfer: function () {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.commands.VoiceTransfer.execute();
                        },
                        voicehold: function () {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.commands.VoiceHold.execute();
                        },
                        voicenewcall: function (destination) {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.commands.VoiceNewCall.execute(destination);
                        },
                        redial: function (destination, contactlistId, activityId)
                        {
                            if (!NixxisContactLink.clientLink)
                        ...
                        voiceforward: function (destination) {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.commands.VoiceForward.execute(destination);
                        },
                        voicehangup: function (destination) {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.commands.VoiceHangup.execute();
                        },
                        terminateContactAndGoReady: function ()
                        {
                            if (!NixxisContactLink.clientLink)
                        ...
                        SetContactTopLabel: function (text) {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.SetContactTopLabel(NixxisContactLink.contactId, text);
                        },
                        SetContactBottomLabel: function (text) {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.SetContactBottomLabel(NixxisContactLink.contactId, text);
                        },
                        SetContactRequestAction: function () {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.SetContactRequestAction(NixxisContactLink.contactId);
                        },
                        //
                        //Agent commands
                        //
                        ...
                        stopRecording: function () {
                            if (!NixxisContactLink.clientLink)
                                return;
                            NixxisContactLink.clientLink.connection.executeCommand(NixxisContactLink.clientLink.codes.commandCodes.VoiceRecord, 'False', NixxisContactLink.contactId);
                        },
                        UserName: function () {
                            if (!NixxisContactLink.clientLink)
                                return;
